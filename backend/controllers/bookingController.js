...
export const createBooking = async (req, res) => {
  ...
  try {
    const { customer, email, phone, car, pickupDate, returnDate, amount, details, address, carImage } = req.body;
    ...
    await Car.findByIdAndUpdate(carSummary.id, { $push: { bookings: bookingEntry } }, { session });
